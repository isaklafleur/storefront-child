				...
				if ($fullName) {
					?>
						<div style="background: #000000; opacity: 0.5; width: 100%;  color:#ffffff; position: fixed; top:0px; z-index: 50; padding:20px;">
							...
							<span style="margin-right:10px; float:right"><a style="color:#ffffff;" href="/wp-login.php?action=register&referral=<?php echo $invite_code; ?>">Register</a></span>
						</div>
					<?php
				}
			}
				...
				if ($fullName) {
					?>
						<div style="background: #000000; opacity: 0.5; width: 100%;  color:#ffffff; position: fixed; bottom:0px; z-index: 50; padding:20px;">
							Hi! I'm <?php echo $fullName; ?>, your shopping consultant. I'm happy to help, you can reach me by: <a style="text-decoration:underline; color:#ffffff; font-weight:bold; " href=""><?php echo $phone; ?></a> or <a style="text-decoration:underline; color:#ffffff; font-weight:bold;" href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a>
						</div>
					<?php
				}
			}
