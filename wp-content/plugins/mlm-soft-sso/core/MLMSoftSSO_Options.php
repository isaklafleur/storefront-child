...
class MLMSoftSSO_Options
{

    const PLUGIN_PREFIX = 'mlmsoft_sso_';
    const TYPE_TEXT_FIELD = 'text';

    const MLMSOFT_PROXY_URL_KEY = 'mlmsoft_proxy_url';
    const MLMSOFT_SSO_URL_KEY = 'mlmsoft_sso_url';
    ...
    public function init()
    {
        ...
        $this->addOption(self::MLMSOFT_PROXY_URL_KEY, 'Proxy URL', self::TYPE_TEXT_FIELD);
        $this->addOption(self::MLMSOFT_SSO_URL_KEY, 'SSO Service URL', self::TYPE_TEXT_FIELD);
    ...
    {
        add_submenu_page(null, 'MLMSoft SSO Options', '', 'activate_plugins', self::PLUGIN_PREFIX . 'settings', [$this, 'options_callback']);
    }
    ...
    {
        if ($file != MLMSoftSSO_Plugin::PLUGIN_BASE_NAME) {
            return $links;
        }
