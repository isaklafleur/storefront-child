...
<div class="woocommerce-billing-fields">
    <div class="woocommerce-billing-fields-mobile">
        <h3><?php esc_html_e('Contact information', 'woocommerce'); ?></h3>
        <?php woocommerce_form_field($emailField['key'], $emailField['field'], $checkout->get_value($emailField['key'])); ?>

        <?php wc_newsletter_subscription_get_template('checkout/newsletter.php', array('checkout' => $checkout)); ?>
